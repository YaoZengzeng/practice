...
import (
	...
	"github.com/YaoZengzeng/practice/kubernetes-controller-example/pkg/client/clientset/versioned/scheme"
...
func (c *ExampleV1Client) Dogs(namespace string) DogInterface {
	return newDogs(c, namespace)
}
